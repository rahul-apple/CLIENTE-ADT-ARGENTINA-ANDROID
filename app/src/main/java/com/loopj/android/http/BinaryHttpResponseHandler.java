    ...
    protected void handleMessage(Message msg) {
        ...
        switch(msg.what) {
            ...
            case FAILURE_MESSAGE:
                response = (Object[])msg.obj;
                //System.out.println(">>>>>>>>>>>>AAAA >> "+response[0].getClass()+"  >>>>"+response[1].getClass());
                System.out.println(">>>>>>>>>>>>AAAA >> "+response[0]+"  >>>>"+response[1]);
                //handleFailureMessage(th2, (byte[])((String)(response[1])).getBytes());
                //handleFailureMessage(th2, (byte[])response[1]);
                //if(response[1].getClass().equals("".getClass()) )
                if(response[1] != null){
                	if(response[1].getClass().equals("".getClass()) )
                	...
                	handleFailureMessage((Throwable)response[0], "Unknown error...".getBytes());
                }
