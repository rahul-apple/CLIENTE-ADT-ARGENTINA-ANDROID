...
public class RegistrationIntentService extends IntentService {
    ...
    void enablePush(final PushNotificationStorage pushNotificationStorage){
        GcmUtil.getInstanceId(this, new ZendeskCallback<String>() {
            ...
            @Override
            public void onError(final ErrorResponse errorResponse) {
                Toast.makeText(RegistrationIntentService.this.getApplicationContext(), getResources().getString(com.zendesk.adtapp.R.string.push_error_obtain_push_id), Toast.LENGTH_LONG).show();
            }
        });
    }
}
