...
import com.zendesk.adtapp.LocalNotification;
...
public class CreateDateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.zendesk.adtapp.R.layout.activity_create_date);
    ...
    protected void onStart() {
        ...
        DatePicker  datePicker  = (DatePicker)this.findViewById(com.zendesk.adtapp.R.id.datePicker);
        TimePicker  timePicker  = (TimePicker)this.findViewById(com.zendesk.adtapp.R.id.timePicker);
        EditText    title   = (EditText)this.findViewById(com.zendesk.adtapp.R.id.nameText);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.zendesk.adtapp.R.menu.menu_create_date, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(com.zendesk.adtapp.R.layout.fragment_create_date, container, false);
